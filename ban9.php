		...
		<form method="post" >	 
		 ...
		 $col6=$_POST['sub']."gp";
				 ...
				 $sql="SELECT COUNT(id) AS sum FROM ".$_POST['classss']."  ";
				  ...
				  $query=" SELECT student_id,roll,student_name,$col1,$col2,$col3,$col4,$col5,$col6  FROM student_info as info,".$table." as class WHERE info.student_id=class.id ORDER BY roll  ";
