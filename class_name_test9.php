 ...
 <table  style="border:1px solid #acacac">
    ...
    <tbody>
    	...
    	?>
			...
			<form method="post" action="insertstu9.php">	 
		 ...
		 <td><input type="number" class="form-control" autocomplete="off"  name="id[]" value=" " /> </td> 
		 	<td><input type="number" class="form-control" autocomplete="off"  name="roll[]" value=" " /> </td>
		 	 <td><SELECT name="forth[]">
                     <option disabled selected>forth_subject</option>
                     <option value="hmatm">Higher_math</option>
                     <option value="agg">Agriculture</option>
                     <option value="comp">Computer</option>
                     <option value="gar">Computer</option>
